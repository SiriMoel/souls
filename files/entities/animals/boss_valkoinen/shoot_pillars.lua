...
if state == 3 then
    ...
    shoot_projectile( valk, "mods/souls/files/entities/animals/boss_valkoinen/proj_pillar.xml", lp_x, lp_y, lp_v_x, lp_v_y )
    shoot_projectile( valk, "mods/souls/files/entities/animals/boss_valkoinen/proj_pillar.xml", rp_x, rp_y, rp_v_x, rp_v_y )
