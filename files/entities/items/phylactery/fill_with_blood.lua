...
function kick( entity_who_kicked )
    local amount_soulblood = tonumber(ComponentGetValue2(comp_mi, "count_per_material_type")[CellFactory_GetType("souls_soul_blood_perfect") + 1]) or 0 --tostring(CellFactory_GetType("souls_soul_blood_1"))
    local amount_soulblood_player = tonumber(ComponentGetValue2(comp_player_mi, "count_per_material_type")[CellFactory_GetType("souls_soul_blood_perfect") + 1]) or 0 
