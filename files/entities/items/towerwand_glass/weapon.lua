...
gun.reload_time = {0,15}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {0,5}
gun.spread_degrees = -1
gun.speed_multiplier = 1.3
gun.mana_charge_speed = {0,0}
gun.mana_max = {10000,17000}
gun.actions = {"LIGHT_BULLET"}
...
ComponentSetValue2( item_comp, "item_name", "Wand of Glass" )
