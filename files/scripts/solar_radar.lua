...
for _,sun_id in pairs(EntityGetInRadiusWithTag( pos_x, pos_y, range, "sun")) do
	...
	if distance > range * 0.8 then
		GameCreateSpriteForXFrames( "mods/moles_n_more/files/particles_radar_sun_faint.png", indicator_x, indicator_y, true, 0, 0, 1, true )
	elseif distance > range * 0.5 then
		GameCreateSpriteForXFrames( "mods/moles_n_more/files/particles_radar_sun_medium.png", indicator_x, indicator_y, true, 0, 0, 1, true )
	else
		GameCreateSpriteForXFrames( "mods/moles_n_more/files/particles_radar_sun_strong.png", indicator_x, indicator_y, true, 0, 0, 1, true )
	end
end